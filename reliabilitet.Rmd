...
Figur 1 viser utviklingen Test 1 til Test 2 fordelt på kjønn. Det typiske målefeilet (typical error, [@hopkins2000]) fra Test 1 til Test 2 er utregnet til å være `r round(reliabilitet$cv, 2)`%. Det maksimale oksygenopptaket til de kvinnelige deltakerne spant seg fra 49.75 ml kg<sup>-1</sup> min<sup>-1</sup> til 54.50 til B, mens det hos de mannlige deltakerne spant seg fra 49.50 ml kg<sup>-1</sup> min<sup>-1</sup> til 62.05 ml kg<sup>-1</sup> min<sup>-1</sup>.
